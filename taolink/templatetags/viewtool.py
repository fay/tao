...
def get_favicon_url(source):
    if source.__str__().startswith('http://www.google.com/reader/'):
        return 'https://www.google.com/reader/ui/favicon.ico'
    m = re.findall('http://([^/]*)/',source)
    domain = m and m[0] or ''
